...
from lstm_language_model_state_1024 import LSTMLanguageModelState1024
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        # Initialize model
        lstm_language_model = LSTMLanguageModelState1024(vocabulary_size=FLAGS.vocabulary_size,
